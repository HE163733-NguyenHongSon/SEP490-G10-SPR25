...
const GuestDoctorDetailPage = ({ params }: DoctorDetailPageProps) => {
    ...
    >
      ...
      <div className="relative container w-90 text-gray-600 p-5 mt-20 mb-5 z-30 bg-white rounded-xl shadow-2xl">
        <div className="flex flex-row p-6">
          <BackButton fallbackPath="/guest/doctors" />
        ...
        {/* Tabs */}
        <Tabs.Root defaultValue="overview" onValueChange={setActiveTab} value={activeTab}>
          ...
          <div className="px-5 py-4 h-fit overflow-y-auto">
            ...
            <Tabs.Content value="schedule">
              <div className="text-center py-6">
                <p className="text-lg mb-4">Bạn cần đăng nhập để xem lịch của bác sĩ</p>
                <Link href="/common/auth/login">
        ...
        <div className="text-center mt-6 pb-4">
          <p className="text-lg mb-4">Hãy đăng nhập để đặt lịch khám với bác sĩ {doctorDetail.userName}</p>
          <Link href="/common/auth/login">

...
export default function EditPatientPage({ params }: { params: { patientId: string } }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const isConfirmed = window.confirm('Bạn có chắc chắn muốn lưu thay đổi thông tin bệnh nhân?');
        ...
        <>
            <div className="p-8 max-w-4xl mx-auto">
                        ...
                        <table className="min-w-full bg-white border border-gray-200 rounded-md shadow-sm">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="p-2 border">{guardianOld.guardian?.userName}</td>
                                    ...
                                    <td className="p-2 border">{guardianOld.guardian?.address}</td>
                                </tr>
                            </tbody>
                        </table>
                    ) : (
                ...
                <div className="mt-12 border-t pt-8">
                    <h2 className="text-xl font-semibold mb-4">Xác nhận giám hộ mới theo ID</h2>

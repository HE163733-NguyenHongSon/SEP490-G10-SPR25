...
const PersonLayout = ({
  ...
  const routes = [
    { path: "./profile", name: "Profile", Image: assets.profile },
    { path: "./reservations", name: "Reservations", Image: assets.reservation },
    { path: "./medical-report", name: "Medical Report", Image: assets.medical_report },
  ];
      ...
      <div className="container mt-28 mb-10 z-30 grid grid-cols-5 text-gray-700 bg-white rounded-xl shadow-2xl">
        <div className="col-span-1 border-r border-gray-300">
          ...
          <div className="flex flex-row items-center justify-start gap-2 mx-7 border-b border-gray-300 pb-5">
            <Image className="w-7 h-7" width={20} height={20} src={assets.ranking} alt="" />
            Ranking:
              ...
              {routes.map((route, index) => (
                <li key={index}>
                  <Link
                    ...
                    //      : "bg-white"} shadow-md`}
                  >
                    <Image  width={7} height={7} src={route.Image} alt="" />
                    {route.name}
                  </Link>
                </li>
              ))}

  ...
  return (
    ...
    >
      <h1 className="text-cyan-600 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-2">
        Tổng quan về
        <span className="underline underline-offset-4 decoration-1 font-light"> chúng tôi</span>
      </h1>
      <p className="text-cyan-500 text-base sm:text-base md:max-w-6xl lg:max-w-full text-center mb-8">
        Chúng tôi là đơn vị y tế hàng đầu với đội ngũ bác sĩ chuyên môn cao và cơ sở vật chất hiện đại. 
        Tại đây, bạn sẽ được trải nghiệm dịch vụ khám chữa bệnh chất lượng với sự tận tâm, chuyên nghiệp và hiệu quả.
      </p>
      <div className="flex flex-col md:flex-row items-center md:items-start md:gap-10">
        ...
        <div className="flex flex-col items-center md:items-start mx-3 text-cyan-500">
          <div className="grid grid-cols-2 gap-6 md:gap-10 w-full 2xl:pr-28">
            <div>
              <p className="text-4xl font-medium text-cyan-500">{numberOfDoctors}+</p>
              <p>Bác sĩ có trình độ</p>
            </div>
            <div>
              <p className="text-4xl font-medium text-cyan-500">{numberOfSpecialties}+</p>
              <p>Chuyên khoa</p>
            </div>
            <div>
              <p className="text-4xl font-medium text-cyan-500">{numberOfServices}+</p>
              <p>Dịch vụ y tế</p>
            </div>
            <div>
          ...
          <p className="m-4 max-w-lg">
            Với sứ mệnh mang đến giải pháp chăm sóc sức khỏe toàn diện, 
            chúng tôi không ngừng nâng cao chất lượng dịch vụ và mở rộng hệ thống chuyên môn nhằm đáp ứng mọi nhu cầu của bệnh nhân.
          </p>

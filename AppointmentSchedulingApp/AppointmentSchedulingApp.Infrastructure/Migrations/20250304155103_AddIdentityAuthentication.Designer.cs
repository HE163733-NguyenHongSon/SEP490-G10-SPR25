...
namespace AppointmentSchedulingApp.Infrastructure.Migrations
{
    ...
    [Migration("20250304155103_AddIdentityAuthentication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Certification", b =>
                {
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Device", b =>
                {
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Doctor", b =>
                {
                    b.Property<int>("DoctorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.DoctorSchedule", b =>
                {
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Feedback", b =>
                {
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.MedicalRecord", b =>
                {
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Patient", b =>
                {
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Reservation", b =>
                {
                    b.Property<int>("ReservationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Room", b =>
                {
                    b.Property<int>("RoomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Service", b =>
                {
                    b.Property<int>("ServiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Slot", b =>
                {
                    b.Property<int>("SlotId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Specialty", b =>
                {
                    b.Property<int>("SpecialtyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.UserRole", b =>
                {
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Certification", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Doctor", "Doctor")
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Doctor", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.User", "DoctorNavigation")
                        .WithOne("Doctor")
                        .HasForeignKey("AppointmentSchedulingApp.Domain.Models.Doctor", "DoctorId")
                        .IsRequired()
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.DoctorSchedule", b =>
                {
                    ...
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Room", "Room")
                        .WithMany("DoctorSchedules")
                        .HasForeignKey("RoomId")
                        .IsRequired()
                        .HasConstraintName("RoomId_FK");

                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Service", "Service")
                        .WithMany("DoctorSchedules")
                        .HasForeignKey("ServiceId")
                        .IsRequired()
                        .HasConstraintName("ServiceId_FK");

                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Slot", "Slot")
                        .WithMany("DoctorSchedules")
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Feedback", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Reservation", "Reservation")
                        .WithOne("Feedback")
                        .HasForeignKey("AppointmentSchedulingApp.Domain.Models.Feedback", "ReservationId")
                        .IsRequired()
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Patient", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.User", "PatientNavigation")
                        .WithOne("Patient")
                        .HasForeignKey("AppointmentSchedulingApp.Domain.Models.Patient", "PatientId")
                        .IsRequired()
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Reservation", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.DoctorSchedule", "DoctorSchedule")
                        .WithMany("Reservations")
                        .HasForeignKey("DoctorScheduleId")
                        .IsRequired()
                        .HasConstraintName("DoctorScheduleId_FK");

                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Patient", "Patient")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.Service", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Category", "Category")
                        .WithMany("Services")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("CategoryId_FK");

                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Specialty", "Specialty")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("AppointmentSchedulingApp.Domain.Models.UserRole", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppointmentSchedulingApp.Domain.Models.User", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("DeviceService", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Device", null)
                        .WithMany()
                    ...
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Service", null)
                        .WithMany()
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("DeviceSpecialty", b =>
                {
                    ...
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Specialty", null)
                        .WithMany()
                        .HasForeignKey("SpecialtyId")
                        .IsRequired()
            ...
            modelBuilder.Entity("DoctorService", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Doctor", null)
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("AppointmentSchedulingApp.Domain.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
